        ...
        <div class="row align-items-center">
            <div class="col-lg-7">
                ...
                <p class="hero-subtitle">
                    Aplikasi resmi dari <strong>Dinas Perikanan Kabupaten Kediri</strong> yang menghadirkan kemudahan bagi masyarakat 
...
<!-- Call to Action -->
<section class="container mb-5">
    <div class="card" style="background: linear-gradient(135deg, var(--primary-blue) 0%, var(--primary-dark) 100%);">
...
<script>
// Initialize Map
var map = L.map('map').setView([-7.5, 112.5], 9);

L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
    attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
}).addTo(map);

var peternakIcon = L.icon({
...
var peternakData = @json($peternaks);

peternakData.forEach(function(peternak) {
    if (peternak.latitude && peternak.longitude) {
        var marker = L.marker([peternak.latitude, peternak.longitude], {icon: peternakIcon})
            .addTo(map);
        
        var popupContent = `
            <div class="p-2">
                <h6 class="fw-bold mb-2">${peternak.user.name}</h6>
                ...
                <span class="badge ${peternak.status_aktif ? 'bg-success' : 'bg-secondary'} mt-2">
