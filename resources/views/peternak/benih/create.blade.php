                ...
                <form action="{{ route('benih.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="jumlah" class="form-control" placeholder="Masukkan jumlah benih"
                                required>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="ukuran" class="form-control" placeholder="Contoh: 3–5 cm, 5–7 cm"
                                required>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="kualitas" class="form-control"
                                placeholder="Contoh: Grade A / B / Bagus" required>
                        </div>
