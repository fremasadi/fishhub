                ...
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <!-- Status -->
                            <td>
                                <span class="badge bg-{{ $item->status_stok == 'Tersedia' ? 'success' : 'secondary' }}">
                                    {{ $item->status_stok }}
                                </span>
                            </td>
                            ...
                            <!-- Validasi -->
                            <td>
                                <span class="badge bg-{{ $item->status_validasi == 'Terverifikasi' ? 'info' : 'warning' }}">
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('benih.edit', $item) }}"
                                       class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit"></i>
                                    </a>

                                    <form action="{{ route('benih.destroy', $item) }}"
                                          method="POST"
