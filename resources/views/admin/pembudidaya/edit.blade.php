...
<div class="container-fluid">
    <div class="mb-4">
        <h1 class="h3 mb-2">Edit Pembudidaya</h1>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('pembudidayas.update', $pembudidaya) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text"
                               ...
                               id="name"
                               name="name"
                               value="{{ old('name', $pembudidaya->user->name) }}"
                               required>
                        @error('name')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email"
                               ...
                               id="email"
                               name="email"
                               value="{{ old('email', $pembudidaya->user->email) }}"
                               required>
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
