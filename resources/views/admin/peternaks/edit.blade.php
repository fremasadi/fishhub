...
<div class="container-fluid">
    <div class="mb-4">
        <h1 class="h3 mb-2">Edit Peternak</h1>
        <!-- <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('peternaks.index') }}">Peternak</a></li>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('peternaks.update', $peternak) }}" method="POST" id="peternakForm">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               ...
                               id="name" 
                               name="name" 
                               value="{{ old('name', $peternak->user->name) }}" 
                               required>
                        @error('name')
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               ...
                               id="no_hp" 
                               name="no_hp" 
                               value="{{ old('no_hp', $peternak->no_hp) }}" 
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('status_aktif') is-invalid @enderror" 
                            ...
                            <option value="1" {{ old('status_aktif', $peternak->status_aktif) == '1' ? 'selected' : '' }}>Aktif</option>
                            <option value="0" {{ old('status_aktif', $peternak->status_aktif) == '0' ? 'selected' : '' }}>Tidak Aktif</option>
                        </select>
                        @error('status_aktif')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('alamat') is-invalid @enderror" 
                              ...
                              name="alamat" 
                              rows="3" 
                              required>{{ old('alamat', $peternak->alamat) }}</textarea>
                ...
                <input type="hidden" id="latitude" name="latitude" value="{{ old('latitude', $peternak->latitude) }}">
                <input type="hidden" id="longitude" name="longitude" value="{{ old('longitude', $peternak->longitude) }}">
...
<script>
    ...
    function initMap() {
        // Get existing location or use default (Jakarta)
